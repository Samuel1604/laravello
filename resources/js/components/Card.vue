<template>
  <div>
    ...
    >
      ...
      >
        <div
          class="text-grey-400 pr-2 hover:text-yellow-700"
          @click="editing = true"
        >
          E
        </div>
        <div class="text-grey-400 hover:text-red-700" @click="cardDelete">
          D
        </div>
      </div>
    </div>
...
import { EVENT_CARD_DELETED, EVENT_CARD_UPDATED } from "./../constant";
